<ul
	class="w-fitfont-normal absolute left-11 top-44 z-[55] leading-8 text-white max-[1100px]:top-[8.7rem] max-[1100px]:flex max-[1100px]:gap-3 max-[500px]:left-8 max-[500px]:top-[6.8rem] max-[500px]:text-sm"
>
