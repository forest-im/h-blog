...
<div
	...
	class={clsx(
		...
		isModal &&
			"max-w-[300px] rounded-xl border-none bg-defaultColor-900 dark:bg-darkDefaultColor-900"
	)}
>
						...
						<div
							class={clsx(
								...
								$page.params.slug === slug
									? "text-pointColor-850 hover:text-pointColor-850"
									: "text-defaultColor-600 hover:text-defaultColor-700 hover:dark:text-darkDefaultColor-800"
							)}
						>
							- {title}
						</div>
